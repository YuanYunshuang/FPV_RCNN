...
class MatcherV1(nn.Module):
    """Correct the localization error and Use NMS to fuse the bounding boxes"""
    def __init__(self, cfg, pc_range, has_noise=True, search_range=None):
        super(MatcherV1, self).__init__()
    ...
    def forward(self, data_dict):
        ...
        data_dict['boxes_fused'], data_dict['scores_fused'] = self.nms_fusion(data_dict)
