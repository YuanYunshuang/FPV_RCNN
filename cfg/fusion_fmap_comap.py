...
class Dataset(object):
    ...
    def __init__(self):
        ...
        self.gps_noise_std = np.array([0.4, 0.4, 0.0, 0.0, 0.0, 4]) # [x, y, z, roll, pitch, yaw]
...
class Optimization:
    def __init__(self):
        ...
        self.PATHS = {
        'run': koko + 'experiments-output/fusion-fmap/no_noise'
    }
